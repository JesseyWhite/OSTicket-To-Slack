...
import certifi
from slackbot.onboarding_tutorial import OnboardingTutorial

# For simplicity we'll store our app data in-memory with the following data structure.
# onboarding_tutorials_sent = {"channel": {"user_id": OnboardingTutorial}}
onboarding_tutorials_sent = {"channel": {"user_id": OnboardingTutorial}}

print(f'name:{OnboardingTutorial}')
...
def message(**payload):
    ...
    print(f'This is the channel ID:{channel_id}')

    if text and text.lower() == "start":
        return start_onboarding(web_client, user_id, channel_id)
    if text and text.lower() == "new":
        return start_onboarding(web_client, user_id, channel_id)
